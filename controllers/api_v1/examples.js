...
examples.get('/:id(\\d+)', async (req, res) => {
...
examples.put('/:id(\\d+)', async (req, res) => {
...
examples.patch('/:id(\\d+)', async (req, res) => {
...
examples.delete('/:id(\\d+)', async (req, res) => {
